	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4" style="text-align: right">
					...
					<button id="insertGroup" class="btn btn-default">添加分组</button>
			...
			<tbody>
				<c:forEach items="${groups }" var="group" varStatus="status">
					<tr>
						...
						<button name="${group.groupId }" class="btn btn-info edit"> 编辑 </button>
						<a href="emgroup?groupId=${ group.groupId}" class="btn btn-info"> 管理 </a> 
						<a href="deleteGroup?groupId=${ group.groupId}" class="btn btn-danger"> 删除 </a> </td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
